...
-- Kronos interop: a second prefix that bypasses the proxy's PLPWR translator.
-- Used for messages with no old-protocol equivalent (per-player normal
-- assignments), so they reach 1.12-client paladins unmodified.
PallyPower.commPrefix2 = "PLPWRX"
C_ChatInfo.RegisterAddonMessagePrefix(PallyPower.commPrefix2)
